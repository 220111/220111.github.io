...
function setup() {
  ...
  flyBoxColors.push(color('#000000'));
  flyBoxColors.push(color('#363636'));
  flyBoxColors.push(color('#575757'));
  flyBoxColors.push(color('#787878'));
  flyBoxColors.push(color('#999999'));
}
